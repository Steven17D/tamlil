...
# speaker's cluster, and the genuine voice's duplicate share (observed 0.36)
# lands right next to a real bleed voice's (0.38). What does separate them is
# how much the voice said that the remote track has no copy of: bleed voices
# measure 5-11% unique characters, a genuine speaker ~47%. Promote a voice to
# remote only when almost nothing it said is unique to the mic.
